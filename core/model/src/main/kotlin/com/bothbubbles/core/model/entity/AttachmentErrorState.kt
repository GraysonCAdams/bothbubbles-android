...
sealed class AttachmentErrorState(
    ...
    companion object {
        ...
        fun fromException(e: Throwable): AttachmentErrorState {
            ...
            return when {
                e is SocketTimeoutException -> NetworkTimeout
                e is UnknownHostException -> NoConnection
                e is ConnectException -> NoConnection
                e is IOException && message.contains("No space left", ignoreCase = true) -> StorageFull
                e is IOException && message.contains("timeout", ignoreCase = true) -> NetworkTimeout
                e is IOException && message.contains("Download failed: 4") -> {
                ...
                e is IOException && message.contains("Download failed: 5") -> {
