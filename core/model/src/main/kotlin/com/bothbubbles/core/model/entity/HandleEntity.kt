...
/**
 * Extension property providing display name with fallback.
 * This is declared here with a simple fallback. For phone number formatting,
 * use the extension in the app module that has access to PhoneNumberFormatter.
 */
val HandleEntity.displayNameSimple: String
...
/**
 * Extension property providing raw display name without "Maybe:" prefix.
 * For phone number formatting, use the extension in the app module.
 */
val HandleEntity.rawDisplayNameSimple: String
    get() = cachedDisplayName
        ?: inferredName
        ?: formattedAddress
        ?: address
