...
class ConversationsViewModel @Inject constructor(
    ...
    // normalizeGuid moved to ConversationFormatters.kt
    ...
    // Original implementation moved to ConversationMappers.kt
    @Suppress("UNUSED")
    private suspend fun ChatEntity.toUiModel_OLD(typingChats: Set<String>): ConversationUiModel {
        ...
        val groupEventText = if (messageType == MessageType.GROUP_EVENT && lastMessage != null) {
            formatGroupEvent(lastMessage, guid, handleRepository)
        } else null
    ...
    // Utility functions (formatRelativeTime, extractFirstName, isVoiceMessage, etc.)
    // moved to ConversationFormatters.kt

    // mergeConversations and mergeChatGroup functions moved to ConversationMappers.kt
}

// UI state, models, and enums moved to ConversationsUiState.kt
